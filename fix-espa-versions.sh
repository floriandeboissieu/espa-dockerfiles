...
cat ${2} | sed \
    -e "s/ESPA_VERSION/${1}/" \
    -e "s/ESPA_PRODUCT_FORMATTER/product_formatter_v1.15.0/" \
    -e "s/ESPA_L2QA_TOOLS/l2qa_tools_v1.7.0/" \
    -e "s/ESPA_SURFACE_REFLECTANCE/surface_reflectance_mar2018/" \
    -e "s/ESPA_SURFACE_TEMPERATURE/st-rit-v1.1.0/" \
